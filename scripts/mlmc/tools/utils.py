...
exp_of_levy_models = {
    ...
    'cgmy02': create_exponential_of_levy_model(ModelType.CGMY)(c=1.230, g=15, m=20, y=0.2),
    'cgmy04': create_exponential_of_levy_model(ModelType.CGMY)(c=0.700, g=15, m=20, y=0.4),
    'cgmy11': create_exponential_of_levy_model(ModelType.CGMY)(c=0.025, g=2, m=4, y=1.1),
...
calibrated_exp_of_levy_models = {key: run_default_calibration(model=val, maturity=cases_data['maturity'])
...
def save_mlmc_coupling_applied_results(rmses, outputs, root_path_results, file_result_name, beta):
