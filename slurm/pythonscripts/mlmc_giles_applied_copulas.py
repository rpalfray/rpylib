...
from scripts.mlmc.application.mlmc_applied_to_copula import (
    coupling_copula_cost_and_levels,
)


if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Generate data for weak/strong convergence graphs as in Giles for"
        "Lévy copulas"
    )
