...
def giles_variances_graphs_sde(model_str: str, max_level: int, mc_paths: int, h0: float):
    ...
    coupling_variances_sde(name=model_str, model=model, mc_paths=mc_paths, h0=h0, max_level=max_level,
...
if __name__ == '__main__':
    ...
    giles_variances_graphs_sde(model_str=args.model, max_level=args.max_level, mc_paths=args.mc_paths, h0=args.h0)
