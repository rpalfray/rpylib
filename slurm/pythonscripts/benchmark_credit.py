...
def generate_benchmark_first_to_default_cds():
    ...
    model1 = create_exponential_of_levy_model(ModelType.HEM)(
        spot=50, intensity=5, sigma=0.05
    )
    model2 = create_exponential_of_levy_model(ModelType.HEM)(
        spot=100, intensity=10, sigma=0.05
    )
    model3 = create_exponential_of_levy_model(ModelType.HEM)(
        spot=150, intensity=20, sigma=0.05
    )
