...
def checks_process_markov_chain(model, product, expected_ioj, expected_vol_adj,
                                expected_log_diffusion_path, expected_log_jump_path):
...
def test_hem_process_markov_chain_testing_value(hem_model, forward):
    ...
    checks_process_markov_chain(hem_model, forward, expected_ioj, expected_vol_adj,
                                expected_log_diffusion_path, expected_log_jump_path)
...
def test_cgmy_process_markov_chain_testing_value(cgmy_model, forward):
    ...
    checks_process_markov_chain(cgmy_model, forward, expected_ioj, expected_vol_adj,
                                expected_log_diffusion_path, expected_log_jump_path)
